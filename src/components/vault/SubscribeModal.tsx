...
import { X, Crown, Check, Lock, CalendarClock } from 'lucide-react';
...
/**
 * Real Subscribe modal for Premium Vault membership.
 * Initiates the Paystack checkout flow if the user is authenticated.
 */
      ...
      <div className="relative w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-fade-in-up vault-surface">
        ...
        <div className="p-6">
          <>
            ...
            <button onClick={handleSubscribe} disabled={loading} className="btn-gold w-full justify-center py-3">
              {loading ? (
                ...
                user ? 'Proceed to Checkout' : 'Sign in to Subscribe'
              )}
            </button>
